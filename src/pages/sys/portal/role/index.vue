  ...
  <PageWrapper class="ztable" contentFullHeight>
    <vxe-grid ref='xGrid' v-bind="gridOptions">
      <template #tbtns>
        ...
        <vxe-button @click="flushPerm()" status="warning">刷新缓存</vxe-button>
      </template>
...
<script lang="ts">
export default {name: 'SysPortalRole', inheritAttrs: false, customOptions: {}}
</script>
...
const gridOptions = reactive<VxeGridProps>(createOption('/sys/portal/role', {}, formData, [
...
const flushPerm=async ()=>{
  await defHttp.post({url: '/sys/portal/role/flush'});
}
</script>
