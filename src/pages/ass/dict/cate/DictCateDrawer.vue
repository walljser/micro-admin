<template>
  <BasicDrawer v-bind="$attrs" :loadingText="vform.loadingText" showFooter title="字典分类" width="70%"
    ...
    <vxe-form title-colon ref="xForm" title-align="right" title-width="100" :data="vform.data" :rules="vform.rules">
      <vxe-form-item title="字典分类名称" field="name" :item-render="{}" span="12" title-width="150">
      ...
      <vxe-form-item title="分类备注" field="notes" :item-render="{}" span="24" title-width="150">
        <template #default="{ data }">
